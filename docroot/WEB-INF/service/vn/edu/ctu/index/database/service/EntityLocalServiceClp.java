...
public class EntityLocalServiceClp implements EntityLocalService {
	public EntityLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public vn.edu.ctu.index.database.model.Entity addEntity(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(entity) });
		}
		catch (Throwable t) {
	...
	public vn.edu.ctu.index.database.model.Entity findByEntityName(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					...
					new Object[] { ClpSerializer.translateInput(entityName) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
